...
# relaxing variable
# 3D
# here we test a normal 'max' operator
...
def inequality_constraints(z, p):
    ...
    return casadi.vertcat(
        ...
        casadi.fmax(xp2, yp2),     # obstacle 2,
...
def generate_pathplanner(create=True, path=''):
    ...
    # Set solver options
    codeoptions = forcespro.CodeOptions('FORCESNLPsolver2_max')
    ...
    if create:
        ...
        solver = forcespro.nlp.Solver.from_directory(path + "FORCESNLPsolver2_max")
