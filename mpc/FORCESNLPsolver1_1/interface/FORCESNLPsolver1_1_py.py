...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver1_1_params_ctypes), ctypes.POINTER(FORCESNLPsolver1_1_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver1_1_info), ctypes.POINTER(FILE))
...
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
 ...
 See also COPYING
    ...
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver1_1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), PyFile_AsFile(fp) , _lib.FORCESNLPsolver1_1_casadi2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver1_1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), None , _lib.FORCESNLPsolver1_1_casadi2forces)
            else:
                exitflag = _lib.FORCESNLPsolver1_1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), fp , _lib.FORCESNLPsolver1_1_casadi2forces)
            libc.fclose(fp)
