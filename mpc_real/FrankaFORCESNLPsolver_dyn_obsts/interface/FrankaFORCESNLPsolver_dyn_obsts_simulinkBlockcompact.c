...
#define S_FUNCTION_NAME FrankaFORCESNLPsolver_dyn_obsts_simulinkBlockcompact
...
typedef FrankaFORCESNLPsolver_dyn_obstsinterface_float FrankaFORCESNLPsolver_dyn_obstsnmpc_float;
