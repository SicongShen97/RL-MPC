...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
   ...
   OUTPUT = FrankaFORCESNLPsolver_dyn_obsts_py.FrankaFORCESNLPsolver_dyn_obsts_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = FrankaFORCESNLPsolver_dyn_obsts_py.FrankaFORCESNLPsolver_dyn_obsts_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FrankaFORCESNLPsolver_dyn_obsts_py.FrankaFORCESNLPsolver_dyn_obsts_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FrankaFORCESNLPsolver_dyn_obsts/lib/FrankaFORCESNLPsolver_dyn_obsts.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FrankaFORCESNLPsolver_dyn_obsts/lib/FrankaFORCESNLPsolver_dyn_obsts_withModel.so'))
    csolver = getattr(_lib,'FrankaFORCESNLPsolver_dyn_obsts_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FrankaFORCESNLPsolver_dyn_obsts/lib/libFrankaFORCESNLPsolver_dyn_obsts_withModel.so'))
    csolver = getattr(_lib,'FrankaFORCESNLPsolver_dyn_obsts_solve')

internal_mem = getattr(_lib,'FrankaFORCESNLPsolver_dyn_obsts_internal_mem')

class FrankaFORCESNLPsolver_dyn_obsts_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FrankaFORCESNLPsolver_dyn_obsts_params = {'x0' : np.array([]),
'xinit' : np.array([]),
...
FrankaFORCESNLPsolver_dyn_obsts_params_types = {'x0' : np.float64,
'xinit' : np.float64,
'all_parameters' : np.float64,
}

class FrankaFORCESNLPsolver_dyn_obsts_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FrankaFORCESNLPsolver_dyn_obsts_outputs = {'x01' : np.array([]),
'x02' : np.array([]),
'x03' : np.array([]),
'x04' : np.array([]),
'x05' : np.array([]),
...
class FrankaFORCESNLPsolver_dyn_obsts_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FrankaFORCESNLPsolver_dyn_obsts_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FrankaFORCESNLPsolver_dyn_obsts_params_ctypes), ctypes.POINTER(FrankaFORCESNLPsolver_dyn_obsts_outputs_ctypes), ctypes.POINTER(FrankaFORCESNLPsolver_dyn_obsts_info), ctypes.POINTER(FrankaFORCESNLPsolver_dyn_obsts_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FrankaFORCESNLPsolver_dyn_obsts_mem)

def FrankaFORCESNLPsolver_dyn_obsts_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FrankaFORCESNLPsolver_dyn_obsts_params_ctypes()
    for par in params_arg:
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FrankaFORCESNLPsolver_dyn_obsts_params_types[par], requirements='F')
    ...
    outputs_py = FrankaFORCESNLPsolver_dyn_obsts_outputs_ctypes()
    info_py = FrankaFORCESNLPsolver_dyn_obsts_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FrankaFORCESNLPsolver_dyn_obsts_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FrankaFORCESNLPsolver_dyn_obsts_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FrankaFORCESNLPsolver_dyn_obsts_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FrankaFORCESNLPsolver_dyn_obsts_adtool2forces)
            else:
                exitflag = _lib.FrankaFORCESNLPsolver_dyn_obsts_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FrankaFORCESNLPsolver_dyn_obsts_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FrankaFORCESNLPsolver_dyn_obsts_outputs:
        FrankaFORCESNLPsolver_dyn_obsts_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FrankaFORCESNLPsolver_dyn_obsts_outputs,int(exitflag),info_py

solve = FrankaFORCESNLPsolver_dyn_obsts_solve
