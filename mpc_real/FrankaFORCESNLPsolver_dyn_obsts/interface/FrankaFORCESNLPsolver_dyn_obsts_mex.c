...
#include "../include/FrankaFORCESNLPsolver_dyn_obsts_memory.h"
...
static FrankaFORCESNLPsolver_dyn_obsts_params params;
static FrankaFORCESNLPsolver_dyn_obsts_output output;
static FrankaFORCESNLPsolver_dyn_obsts_info info;
static FrankaFORCESNLPsolver_dyn_obsts_mem * mem;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1)
	{
		mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FrankaFORCESNLPsolver_dyn_obsts_mex' for details.");
	}    
	if (nlhs > 3) 
	{
    ...
    if (mem == NULL)
    {
        mem = FrankaFORCESNLPsolver_dyn_obsts_internal_mem(0);
    }
	...
	#if SET_PRINTLEVEL_FrankaFORCESNLPsolver_dyn_obsts > 0
	...
	exitflag = FrankaFORCESNLPsolver_dyn_obsts_solve(&params, &output, &info, mem, fp, pt2function_FrankaFORCESNLPsolver_dyn_obsts);
