...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
   ...
   OUTPUT = FrankaFORCESNLPsolver_10mm_py.FrankaFORCESNLPsolver_10mm_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = FrankaFORCESNLPsolver_10mm_py.FrankaFORCESNLPsolver_10mm_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FrankaFORCESNLPsolver_10mm_py.FrankaFORCESNLPsolver_10mm_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FrankaFORCESNLPsolver_10mm/lib/FrankaFORCESNLPsolver_10mm.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FrankaFORCESNLPsolver_10mm/lib/FrankaFORCESNLPsolver_10mm_withModel.so'))
    csolver = getattr(_lib,'FrankaFORCESNLPsolver_10mm_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FrankaFORCESNLPsolver_10mm/lib/libFrankaFORCESNLPsolver_10mm_withModel.so'))
    csolver = getattr(_lib,'FrankaFORCESNLPsolver_10mm_solve')

internal_mem = getattr(_lib,'FrankaFORCESNLPsolver_10mm_internal_mem')

class FrankaFORCESNLPsolver_10mm_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FrankaFORCESNLPsolver_10mm_params = {'x0' : np.array([]),
'xinit' : np.array([]),
...
FrankaFORCESNLPsolver_10mm_params_types = {'x0' : np.float64,
'xinit' : np.float64,
'all_parameters' : np.float64,
}

class FrankaFORCESNLPsolver_10mm_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FrankaFORCESNLPsolver_10mm_outputs = {'x01' : np.array([]),
'x02' : np.array([]),
'x03' : np.array([]),
'x04' : np.array([]),
'x05' : np.array([]),
...
class FrankaFORCESNLPsolver_10mm_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FrankaFORCESNLPsolver_10mm_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FrankaFORCESNLPsolver_10mm_params_ctypes), ctypes.POINTER(FrankaFORCESNLPsolver_10mm_outputs_ctypes), ctypes.POINTER(FrankaFORCESNLPsolver_10mm_info), ctypes.POINTER(FrankaFORCESNLPsolver_10mm_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FrankaFORCESNLPsolver_10mm_mem)

def FrankaFORCESNLPsolver_10mm_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FrankaFORCESNLPsolver_10mm_params_ctypes()
    for par in params_arg:
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FrankaFORCESNLPsolver_10mm_params_types[par], requirements='F')
    ...
    outputs_py = FrankaFORCESNLPsolver_10mm_outputs_ctypes()
    info_py = FrankaFORCESNLPsolver_10mm_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FrankaFORCESNLPsolver_10mm_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FrankaFORCESNLPsolver_10mm_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FrankaFORCESNLPsolver_10mm_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FrankaFORCESNLPsolver_10mm_adtool2forces)
            else:
                exitflag = _lib.FrankaFORCESNLPsolver_10mm_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FrankaFORCESNLPsolver_10mm_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FrankaFORCESNLPsolver_10mm_outputs:
        FrankaFORCESNLPsolver_10mm_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FrankaFORCESNLPsolver_10mm_outputs,int(exitflag),info_py

solve = FrankaFORCESNLPsolver_10mm_solve
