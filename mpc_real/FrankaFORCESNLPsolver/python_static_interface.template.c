 ...
 *  - FrankaFORCESNLPsolver
 *  - "include/FrankaFORCESNLPsolver.h"
 *  - FrankaFORCESNLPsolver_adtool2forces
 *  - FrankaFORCESNLPsolver_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FrankaFORCESNLPsolver, _float)
#define SOLVER_FUN_NAME CONCATENATE(FrankaFORCESNLPsolver, _solve)

#include "include/FrankaFORCESNLPsolver.h"

/* Header of external evaluation function */
solver_int32_default FrankaFORCESNLPsolver_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FrankaFORCESNLPsolver_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FrankaFORCESNLPsolver_adtool2forces);
}
