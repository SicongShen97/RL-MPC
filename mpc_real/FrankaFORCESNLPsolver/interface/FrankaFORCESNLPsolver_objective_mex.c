...
typedef FrankaFORCESNLPsolver_float solver_float;
...
void copyCArrayToM_FrankaFORCESNLPsolver(FrankaFORCESNLPsolver_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FrankaFORCESNLPsolver(FrankaFORCESNLPsolver_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FrankaFORCESNLPsolver(double *src, FrankaFORCESNLPsolver_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
        *dest++ = (FrankaFORCESNLPsolver_float) (*src++) ;
    }
}

void copyMValueToC_FrankaFORCESNLPsolver(double * src, FrankaFORCESNLPsolver_float * dest)
{
	*dest = (FrankaFORCESNLPsolver_float) *src;
}
...
extern solver_int32_default (FrankaFORCESNLPsolver_float *x, FrankaFORCESNLPsolver_float *y, FrankaFORCESNLPsolver_float *l, FrankaFORCESNLPsolver_float *p, FrankaFORCESNLPsolver_float *f, FrankaFORCESNLPsolver_float *nabla_f, FrankaFORCESNLPsolver_float *c, FrankaFORCESNLPsolver_float *nabla_c, FrankaFORCESNLPsolver_float *h, FrankaFORCESNLPsolver_float *nabla_h, FrankaFORCESNLPsolver_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FrankaFORCESNLPsolver(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FrankaFORCESNLPsolver(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FrankaFORCESNLPsolver(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FrankaFORCESNLPsolver(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
