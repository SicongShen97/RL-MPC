 ...
 *  - FrankaFORCESNLPsolver_5mm
 *  - "include/FrankaFORCESNLPsolver_5mm.h"
 *  - FrankaFORCESNLPsolver_5mm_adtool2forces
 *  - FrankaFORCESNLPsolver_5mm_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FrankaFORCESNLPsolver_5mm, _float)
#define SOLVER_FUN_NAME CONCATENATE(FrankaFORCESNLPsolver_5mm, _solve)

#include "include/FrankaFORCESNLPsolver_5mm.h"

/* Header of external evaluation function */
solver_int32_default FrankaFORCESNLPsolver_5mm_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FrankaFORCESNLPsolver_5mm_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FrankaFORCESNLPsolver_5mm_adtool2forces);
}
