...
/* Generated by FORCESPRO v6.0.0 on Thursday, August 25, 2022 at 10:43:17 AM */
...
{
    /* vector of size 50 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x0[50];

    /* vector of size 2 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float xinit[2];

    /* vector of size 120 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float all_parameters[120];
...
{
    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x01[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x02[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x03[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x04[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x05[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x06[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x07[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x08[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x09[5];

    /* vector of size 5 */
    FrankaFORCESNLPsolver_dyn_sqr_obsts_float x10[5];
...
/* Time of Solver Generation: (UTC) Thursday, August 25, 2022 10:43:18 AM */
...
/* Solver Id: bf1862ca-bf77-4426-9138-c076c101261a */
