...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
	...
	copyCArrayToM_FrankaFORCESNLPsolver_dyn_lifted_obsts(c, mxGetPr(c_mex), neq);
	copyCArrayToM_FrankaFORCESNLPsolver_dyn_lifted_obsts(jacc, mxGetPr(jacc_mex), neq*nvar);
	plhs[0] = c_mex;
	plhs[1] = jacc_mex;
