...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
	...
	copyCArrayToM_FrankaFORCESNLPsolver_dyn_lifted_obsts(h, mxGetPr(h_mex), dimh);
	copyCArrayToM_FrankaFORCESNLPsolver_dyn_lifted_obsts(jach, mxGetPr(jach_mex), dimh*nvar);
	plhs[0] = h_mex;
	plhs[1] = jach_mex;
