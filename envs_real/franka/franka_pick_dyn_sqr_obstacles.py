...
MODEL_XML_PATH = os.path.join(os.getcwd(), 'envs_real', 'assets', 'franka', 'franka_pick_dyn_sqr_obstacles.xml')
...
class FrankaPickDynSqrObstaclesEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse', n_substeps=20):
        ...
        super(FrankaPickDynSqrObstaclesEnv, self).__init__(
