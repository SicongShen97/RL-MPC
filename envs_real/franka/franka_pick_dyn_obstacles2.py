...
MODEL_XML_PATH = os.path.join(os.getcwd(), 'envs_real', 'assets', 'franka', 'franka_pick_dyn_obstacles2.xml')
...
class FrankaPickDynObstaclesEnv2(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse', n_substeps=20):
        ...
        super(FrankaPickDynObstaclesEnv2, self).__init__(
    ...
    def step(self, action):
        ...
        return super(FrankaPickDynObstaclesEnv2, self).step(action)
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(FrankaPickDynObstaclesEnv2, self).render(mode, width, height)
