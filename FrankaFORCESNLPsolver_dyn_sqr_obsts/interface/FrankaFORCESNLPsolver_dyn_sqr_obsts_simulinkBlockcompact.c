...
#define S_FUNCTION_NAME FrankaFORCESNLPsolver_dyn_sqr_obsts_simulinkBlockcompact
...
typedef FrankaFORCESNLPsolver_dyn_sqr_obstsinterface_float FrankaFORCESNLPsolver_dyn_sqr_obstsnmpc_float;
