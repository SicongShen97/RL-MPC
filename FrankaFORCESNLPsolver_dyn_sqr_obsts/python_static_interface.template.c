 ...
 *  - FrankaFORCESNLPsolver_dyn_sqr_obsts
 *  - "include/FrankaFORCESNLPsolver_dyn_sqr_obsts.h"
 *  - FrankaFORCESNLPsolver_dyn_sqr_obsts_adtool2forces
 *  - FrankaFORCESNLPsolver_dyn_sqr_obsts_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FrankaFORCESNLPsolver_dyn_sqr_obsts, _float)
#define SOLVER_FUN_NAME CONCATENATE(FrankaFORCESNLPsolver_dyn_sqr_obsts, _solve)

#include "include/FrankaFORCESNLPsolver_dyn_sqr_obsts.h"

/* Header of external evaluation function */
solver_int32_default FrankaFORCESNLPsolver_dyn_sqr_obsts_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FrankaFORCESNLPsolver_dyn_sqr_obsts_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FrankaFORCESNLPsolver_dyn_sqr_obsts_adtool2forces);
}
